...
- Rows: 5000 · end-to-end (incl. replay): 0.41583 ms/row

| stage | latency (ms/row) | % of end-to-end | isolation |
|---|---|---|---|
| Runtime Context (RCL plane-B) | 0.026908 | 6.47% | wrapped FreshnessClock + CommitActuateJournal (timers only) |
| Replay (ERTuple manifest) | 0.020330 | 4.89% | frozen write_replay_manifest (write_pipeline_manifest) |
